...
const endDate = new Date('2023-12-31T07:00:00.000Z')
...
<template>
  <main class="text-center h-screen max-h-screen w-full flex flex-col overflow-hidden">
    <div class="pt-8">
      <div class="">Let's read</div>
      <div class="text-3xl">The Book of Mormon</div>
    </div>
    <div class="py-4">
      <div><span class="font-bold">Finish by:</span> {{ endDate.toDateString() }}</div>
    </div>
    <div class="w-full flex-grow overflow-y-scroll px-4 mb-8">
