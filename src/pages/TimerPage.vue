...
<template>
  <div class="p-4 border-2 border-slate-300 rounded-lg m-2 flex max-w-fit">
    <div
      id="timer"
      class="relative rounded-full h-48 min-h-48 w-48 min-w-48 border-8 border-slate-600 bg-white dark:bg-slate-800"
    >
      <div
        id="shade"
    ...
    <div class="ml-4">
      <div>
        <span class="dark:text-white">Minutes:</span>
        <input
          type="text"
          pattern="[0-9\s]"
          maxlength="2"
          class="w-10 border border-black rounded-lg text-xs text-center px-2 py-1"
          v-model="customValue"
          @keyup.enter="
            () => {
      ...
      <div class="flex justify-center gap-2 mt-4">
        <button
          ...
          class="flex justify-center items-center h-10 w-10 rounded-full bg-sky-300 text-slate-600 disabled:bg-opacity-40 disabled:text-opacity-40"
        >
          <svg
        ...
        <button
          ...
          @click="startTimer()"
          :disabled="!!timerInterval || durationInMiliseconds === 0"
          class="flex justify-center items-center h-10 w-10 rounded-full bg-emerald-400 text-slate-600 disabled:bg-opacity-40 disabled:text-opacity-40"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <button
          ...
          class="flex justify-center items-center h-10 w-10 rounded-full bg-yellow-400 text-slate-600 disabled:bg-opacity-40 disabled:text-opacity-40"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
